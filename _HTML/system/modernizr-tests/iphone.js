...
{
  "name": "iphone",
  "property": ["iphone", "iphone4", "iphone5", "iphone6", "iphone6plus", "iphonex"]
}
!*/

define(['Modernizr', 'tests'], function (Modernizr, tests) { // eslint-disable-line no-undef
	var iPhone = /iphone/i.test(window.navigator.userAgent);
	 ...
	 * @name iphonex
	 */
	Modernizr.addTest('iphonex', (iPhone && (iPhoneWidth === 375 && iPhoneHeight === 812)));
});
