...
const configSystem = {
	...
	/**
	 * Флаг использования критикал стилей в сборке
	 * @type {boolean}
	 * @sourceCode
	 */
	useCritical: /* WS-REPLACE=>`${data.useCritical}` */false/* WS-REPLACE-END */,

	/**
	 * Использование sourcemap'ов в production сборке
	 * @type {boolean}
	 * @sourceCode
	 */
	useSourcemapsOnProduction: /* WS-REPLACE=>`${data.useSourcemapsOnProduction}` */false/* WS-REPLACE-END */,

	/**
	 * Имя ID перед которым будут вставлены инлайновые стили,
	 * которые асинхронно загружаются style-loader'ом системой сборки webpack
	 * @type {string}
	 * @sourceCode
	 */
	styleLoaderInsertAtId: 'webpack-style-loader-insert-before-this',
